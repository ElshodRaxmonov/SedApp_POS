...
int main(int argc, char *argv[])
{
    ...
    GtkWidget *order_view = GTK_WIDGET(gtk_builder_get_object(builder, "order_view"));
    ...
    /* Apply colorful CSS theme */
    apply_css_theme(window);
